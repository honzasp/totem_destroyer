Box2D Version 2.0.1
Clipped and (quite) edited for Hocwar

Changes:
 - add <string.h> for files where it is needed (this is bug in Box2D)
 - remove Examples, Build, Library, Documentation and Contrib
 - edit Makefile (with automake)
